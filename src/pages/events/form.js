      ...
      <Row>
        <Col>
          <TextInputWithLabel
            ...
            name="date"
            value={form.date}
            type="datetime-local" // type datetime-local untuk menampilkan date dan time
            onChange={handleChange}
          />
        </Col>
        <Col>
          ...
          <Col sm={6}>
            <InputGroup className="mb-3" key={index}>
              <FormControl
                ...
                name="key"
                onChange={(e) => {
                  handleChangeKeyPoint(e, index); // onChange berdasarkan indexnya, dan kirim target valuenya yg kita ketikan
                }}
              />
              {/* jika keypointnya tidak sama dengan 0 maka munculin button close, ini untuk ilangin form keypoint*/}
              {index !== 0 && (
